...
source: "https://zenn.dev/ddpmntcpbr/books/rna-hands-on/viewer/next-02"
author:
published:
created: 2026-04-29
description:
...
>
> Header / Footer などのレイアウトコンポーネントの配置場所は `src/app/layout.tsx` に変わる。
> サーバーコンポーネントでの実装については「記事一覧ページのモックを実装」のメモを参照。
...
![](https://static.zenn.studio/user-upload/bf8c9ccb0687-20230724.png)
...
<iframe src="https://embed.zenn.studio/card#zenn-embedded__cd996e42f4c14" frameborder="0"></iframe>
...
![](https://static.zenn.studio/user-upload/3ed19cedaa6f-20230724.png)
...
![](https://static.zenn.studio/user-upload/174470e35fa4-20230724.png)
...
![](https://static.zenn.studio/user-upload/5c28cffc625c-20230724.png)
...
<iframe src="https://embed.zenn.studio/card#zenn-embedded__103ad8c7e6846" frameborder="0"></iframe>

↓

`<AppBar>` はMUIが提供するコンポーネントで、これを用いることでヘッダーを簡単に実装することができます。

<iframe src="https://embed.zenn.studio/card#zenn-embedded__2facb5e41edb6" frameborder="0"></iframe>
...
![](https://static.zenn.studio/user-upload/4bf07d21347a-20230724.png)

↓

`<Button>` はMUIが提供するコンポーネントで、これを用いることでボタン要素を簡単に実装することができます。

<iframe src="https://embed.zenn.studio/card#zenn-embedded__b532b3154983e" frameborder="0"></iframe>
...
![](https://static.zenn.studio/user-upload/14cfab222fba-20230730.png)
...
![](https://static.zenn.studio/user-upload/49e994a94b80-20230730.png)
...
![](https://static.zenn.studio/user-upload/77545764e0d6-20230806.gif)
...
![](https://static.zenn.studio/user-upload/80b01b1e4b99-20230806.gif)
...
<iframe src="https://embed.zenn.studio/card#zenn-embedded__24d4957c95bdd" frameborder="0"></iframe>
...
![](https://static.zenn.studio/user-upload/257f6554718d-20230730.gif)
...
![](https://static.zenn.studio/user-upload/cbcf028d3427-20230730.png)
...
<iframe src="https://embed.zenn.studio/card#zenn-embedded__78ee47d210528" frameborder="0"></iframe>
...
トップページ（ [http://localhost:8000/](http://localhost:8000/) ）にアクセスすると、画面下部にページネーション要素が追加されていることが確認できます。

![](https://static.zenn.studio/user-upload/6132d4420722-20230726.png)
...
![](https://static.zenn.studio/user-upload/09620f489116-20230730.png)
...
<iframe src="https://embed.zenn.studio/card#zenn-embedded__18cc2889eda84" frameborder="0"></iframe>
...
![](https://static.zenn.studio/user-upload/c52acb416da1-20230726.png)
