---
title: "【1. 環境構築編】GitHub Actions CI設定｜【独学ポートフォリオ開発応援】実務未経験から学べる！Rails×Next.js×AWSハンズオン解説"
source: "https://zenn.dev/ddpmntcpbr/books/rna-hands-on/viewer/setup-07"
author:
published:
created: 2026-04-29
description:
...
> | 設定箇所 | 教材 | 本プロジェクト |
> |---------|------|--------------|
> | Ruby バージョン | `3.1.2` | `3.3.7` |
> | MySQL イメージ | `mysql:8.0.32` | `mysql:8.4` |
> | ESLint 設定ファイル | `.eslintrc.json` | `eslint.config.mjs`（Flat Config） |
>
> **eslint ジョブの Node バージョン指定を追加推奨:**
>
> ```yaml
> eslint:
...
![](https://static.zenn.studio/user-upload/97e6b6da2b13-20230827.png)

![](https://static.zenn.studio/user-upload/51a3bd72ea61-20230827.png)
