...
source: "https://zenn.dev/ddpmntcpbr/books/rna-hands-on/viewer/setup-01"
author:
published:
created: 2026-04-29
description:
...
![](https://static.zenn.studio/user-upload/6ca6f16faed8-20230612.png)
...
<iframe src="https://embed.zenn.studio/card#zenn-embedded__5b742788ccbf1" frameborder="0"></iframe>
...
![](https://static.zenn.studio/user-upload/7877e2e01bb7-20230611.png)
...
git push の先を新規作成したリポジトリに向ける（具体的なコマンド内容は各自github画面を参照）
