...
source: "https://zenn.dev/ddpmntcpbr/books/rna-hands-on/viewer/setup-04"
author:
published:
created: 2026-04-29
description:
...
| ファイル名 | 役割 |
| --- | --- |
| spec/spec\_helper.rb | rspec全体の設定ファイル |
| spec/rails\_helper.rb | railsに関するrspecの設定ファイル |
...
## health\_check\_controller#index に対するテスト
...
<iframe src="https://embed.zenn.studio/card#zenn-embedded__a4d54650da177" frameborder="0"></iframe>
